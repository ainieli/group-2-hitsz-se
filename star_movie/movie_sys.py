...
kivy.resources.resource_find("simhei.ttf")			  # 黑体
# 注册字体
LabelBase.register("msimhei_labelBase","simhei.ttf")
kivy.core.text.Label.register("simhei_label","simhei.ttf")
# 加载字体资源
kivy.resources.resource_find("STCAIYUN.TTF")			# 华文彩云
# 注册字体
LabelBase.register("STCAIYUN_labelBase","STCAIYUN.TTF")		# 黑体
kivy.core.text.Label.register("STCAIYUN_label","STCAIYUN.TTF")  # 华文彩云
